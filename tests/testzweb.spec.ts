...
test('Teste de QA - Gabriel Fernandes Debiasi', async ({ page }) => {
  ...
  console.log(
    'Teste concluído com sucesso - NF-e transmitida e DANFE gerado produto listado correto'
  );
